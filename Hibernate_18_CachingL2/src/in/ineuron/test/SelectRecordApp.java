...
public class SelectRecordApp {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			InsurancePolicy policy1 = session.get(InsurancePolicy.class, 3L);
			System.out.println("1:: "+policy1);
			System.out.println("------------------------");//gets from DB put in L2-cache and in L1-cache
			
			InsurancePolicy policy2 = session.get(InsurancePolicy.class, 3L);
			...
			InsurancePolicy policy3 = session.get(InsurancePolicy.class, 3L);
			...
			InsurancePolicy policy4 = session.get(InsurancePolicy.class, 3L);
